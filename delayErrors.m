...
varstdpatternpeakarr=0*varstdarr;
for varindex=1:length(varstdarr)
    varstd=varstdarr(varindex)
...
%     print([num2str(varstd) 'patternerr.png'],'-dpng')
    ...
    varstdpatternpeakarr(varindex)=varstdpatternpeak;
end

plot(varstdarr,varstdpatternpeakarr);hold on
