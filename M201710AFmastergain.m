...
sigt1=[zeros(1,2000) sigeneratorfor2d( t(2001:6001),  'lfm', 0e9, centerfreq ) zeros(1,2000)];
...
xwidthdraw2 = profileAnalyzor1d(dgraxis, sqrt(engue),'gain norm','measured',1/sqrt(2),1,1,30);
